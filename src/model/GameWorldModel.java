...
aircraft = new Aircraft(new Vector2D (400, -1000), 15, new Vector2D(5.2, 0), 6000, new Vector2D (900, 100), 300, new Vector2D(5,5), 2, 7.0);
missile = new Missile(new Vector2D (1000, 440), 5, new Vector2D(0, 0), 2, new Vector2D (0, 0), 5000, new Vector2D(0, 0), 1, 2, aircraft);
